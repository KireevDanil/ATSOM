...
def task1_GaussBlur(img_path,k_size, deviation):
...
def Canny_method(kernel_size=5,deviation=0,low_percent=0.02, high_percent=0.4,img_path='bike.jpg'):
    blrd_img = task1_GaussBlur(img_path, kernel_size, deviation)
